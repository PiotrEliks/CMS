...
export default function ContentPreviewPage() {
    ...
    useEffect(() => {
        if (
            ...
            !mediaCache.has(content.cover_media_id)
        ) {
    ...
    return (
        <>
            ...
            <PageBreadcrumb
                ...
                items={[
                    { label: `${content.title}`, path: `/contents/${id}/edit` },
                ]}
            />
                    ...
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex-1">
                            <p className="font-medium text-gray-900 dark:text-white">
                                {mediaCache.get(section.media_ids[0])?.title ||
                                    'Dokument PDF'}
                            </p>
...
function HeroComponent({ data }: { data: any }) {
    return (
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-12 rounded-lg">
            ...
            <p className="text-xl">
                {data.slides?.[0]?.subtitle || 'Subtitle'}
            </p>
        </div>
    )
}
            ...
            <div className="max-w-md mx-auto space-y-2">
                {data.hours?.map((hour: any, index: number) => (
                    ...
                    >
                        ...
                        <span
                            className={
                                hour.closed ? 'text-red-600' : 'text-gray-700'
                            }
                        >
