  ...
  return (
    <>
      <PageMeta
        ...
        description="To jest strona zarządzania ustawieniami strony w panelu administracyjnym"
      />
      ...
      <div className="space-y-6">
        ...
        {settings && (
          <>
            ...
            {activeTab === 'header' && (
              <HeaderSettings settings={settings.header} />
            )}
            {activeTab === 'footer' && (
              <FooterSettings settings={settings.footer} />
            )}
            {activeTab === 'social' && (
              <SocialMediaSettings settings={settings.social_media} />
            )}
          </>
        )}
      </div>
