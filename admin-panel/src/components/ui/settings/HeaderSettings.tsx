            ...
            <div className="space-y-6">
                <div>
                    ...
                    <MediaSelector
                        ...
                        onRemove={() =>
                            handleChange('header_logo_media_id', undefined)
                        }
                        allowedTypes={['image']}
                    />
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        Rekomendowany rozmiar: 200x50px (PNG z przezroczystym
                        tłem)
                    </p>
                </div>
                ...
                <div>
                    ...
                    <select
                        ...
                        onChange={(e) =>
                            handleChange('header_menu_id', e.target.value)
                        }
                ...
                {backgroundType === 'image' && (
                    <div>
                        ...
                        <MediaSelector
                            selectedMediaId={
                                settings.header_background_media_id
                            }
                            onSelect={(mediaId) =>
                                handleChange(
                                    'header_background_media_id',
                                    mediaId
                                )
                            }
                            onRemove={() =>
                        ...
                        />
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                            Rekomendowany rozmiar: 1920x400px. Obraz zostanie
                            automatycznie dopasowany.
                        </p>
                    </div>
                )}
