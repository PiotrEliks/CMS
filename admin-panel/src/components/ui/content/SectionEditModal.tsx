        ...
        if (mediaModalMode === 'multiple') {
            ...
            setMediaObjects((prev) => {
                ...
                normalizedIncoming.forEach((newM) => {
                    if (
                        !combinedMedia.find((m) => m.media_id === newM.media_id)
                    ) {
                        ...
                        {loadingMedia ? (
                            ...
                            <div className="space-y-3">
                                ...
                                <Button
                                    ...
                                    variant="outline"
                                    onClick={(e) =>
                                        openMediaModal('multiple', ['image'], e)
                                    }
                                >
                                    Dodaj więcej zdjęć
                                </Button>
            ...
            return (
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            value={
                                formData.settings?.video_provider || 'youtube'
                            }
                            onChange={(e) =>
                                handleSettingsChange(
                                    'video_provider',
            ...
            return (
                <div>
                    ...
                    <textarea
                        ...
                        onChange={(e) =>
                            handleSettingsChange('embed_code', e.target.value)
                        }
                        rows={8}
