    ...
    <div className="space-y-4">
      <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        <p className="text-sm text-blue-800 dark:text-blue-200">
          <strong>Kolejność wyświetlania na stronie publicznej:</strong>{' '}
          Przeciągnij i upuść elementy, aby zmienić ich kolejność. Możesz
          mieszać proste sekcje z komponentami PageBuilder.
        </p>
      </div>
      ...
      <div className="flex items-center gap-6 text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="flex items-center gap-2">
          ...
          <span>
            {items.filter((i) => i.type === 'component').length} komponentów
          </span>
        </div>
        <div className="flex items-center gap-2">
