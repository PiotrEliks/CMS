    ...
    const handleSave = async () => {
        ...
        try {
            if (isNew) {
                ...
                await api.put(
                    `/menus/menu-items/${item.menu_item_id}`,
                    dataToSave
                )
            }
            onSuccess()
            ...
            alert(
                error.response?.data?.error || 'Nie udało się zapisać pozycji'
            )
        } finally {
            setLoading(false)
        }
                                ...
                                <label className="flex items-center gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500 dark:text-gray-400">
                                            Tylko etykieta (np. dla kategorii
                                            nadrzędnych)
                                        </div>
                                    </div>
                                </label>
                        ...
                        {linkType === 'external' && (
                            <div className="pl-7">
                                ...
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                                    Podaj pełny URL (zaczynający się od http://
                                    lub https://)
                                </p>
                            </div>
                        )}
