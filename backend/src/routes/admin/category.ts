...
const router = Router();
router.get('/categories/tree', (req, res) => categoryController.getCategoryTree(req, res));
router.get('/categories/slug/:slug', (req, res) => categoryController.getCategoryBySlug(req, res));
...
router.get('/contents/:contentId/categories', authorize('content.read'), (req, res) =>
  categoryController.getCategoriesByContent(req, res)
);

router.post('/contents/:contentId/categories', authorize('content.update_any'), (req, res) =>
  categoryController.assignCategoriesToContent(req, res)
);
