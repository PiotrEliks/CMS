...
router.get('/code/:code/items', (req, res) => menuController.getMenuByCodeWithItems(req, res));

router.use(requireAuth);

router.get('/', authorize('menu.read'), (req, res) => menuController.getMenus(req, res));

router.get('/:id', authorize('menu.read'), (req, res) => menuController.getMenu(req, res));

router.get('/code/:code', authorize('menu.read'), (req, res) =>
  menuController.getMenuByCode(req, res)
);

router.post('/', authorize('menu.create'), (req, res) => menuController.createMenu(req, res));

router.put('/:id', authorize('menu.update'), (req, res) => menuController.updateMenu(req, res));

router.delete('/:id', authorize('menu.delete'), (req, res) => menuController.deleteMenu(req, res));
