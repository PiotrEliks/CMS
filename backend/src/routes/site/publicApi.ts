...
router.get('/public/homepage', (req, res) => publicApiController.getHomepage(req, res));

router.get('/public/pages', (req, res) => publicApiController.getPages(req, res));
router.get('/public/pages/:slug', (req, res) => publicApiController.getPage(req, res));
...
router.get('/public/menus/:code', (req, res) => publicApiController.getMenu(req, res));

router.get('/public/categories', (req, res) => publicApiController.getCategories(req, res));
