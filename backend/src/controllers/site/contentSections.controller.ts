...
export const getSections = asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
        const sections =
            await contentSectionService.getSectionsByContentId(contentId)
...
export const updateSection = asyncHandler(
    async (req: Request, res: Response) => {
        ...
        try {
            const section = await contentSectionService.updateSection(
                sectionId,
                {
                    section_type,
                    heading,
...
export const deleteSection = asyncHandler(
    async (req: Request, res: Response) => {
        ...
        try {
            const section =
                await contentSectionService.getSectionById(sectionId)
...
export const reorderSections = asyncHandler(
    async (req: Request, res: Response) => {
        ...
        try {
            const sections = await contentSectionService.reorderSections(
                contentId,
                items
            )
...
export const duplicateSection = asyncHandler(
    async (req: Request, res: Response) => {
        const { contentId, sectionId } = req.params

        try {
            const section =
                await contentSectionService.duplicateSection(sectionId)
